...
import { isOnboardingComplete } from '../utils/onboardingToken';
      ...
      <div className="flex flex-col h-full px-6 pb-8">
        ...
        >
          <img 
            ...
            className="w-[90%] max-w-[700px] object-contain mx-auto scale-125"
          />
        </motion.div>
        ...
        <div className="space-y-4">
          <motion.h1 
            className="text-white text-3xl font-bold leading-tight mb-10"
            variants={itemVariants}
          >
            Track your fitness journey with our comprehensive workout planner.
          </motion.h1>
